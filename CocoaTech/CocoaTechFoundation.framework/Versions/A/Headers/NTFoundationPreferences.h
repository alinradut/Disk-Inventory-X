...
@interface NTFoundationPreferences : NSObject <PrefsBoxDelegate>
{
    NTPrefsBoxMgr *_prefsBoxMgr;
    NTPrefsBox *_prefsBox;
    BOOL _useSmallFontForContextualMenu;
}

+ (id)sharedInstance;
- (id)init;
- (void)dealloc;
- (void)setUseSmallFontForContextualMenu:(BOOL)arg1;
- (BOOL)useSmallFontForContextualMenu;
